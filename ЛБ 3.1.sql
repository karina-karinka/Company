...
-- (5, 'Mercury', 'Ternopil', NULL, 34), не може бути NULL
(5, 'Mercury', 'Ternopil', 'Vernadskogo', 34),
...
(38,'ViktorKovalov','Viktor','Kovalov','Seller','2002-12-19',3,11,3500,175), -- position  не може бути NULL 
...
USE company;
INSERT INTO customer (customer_id,first_name,last_name,gender,birth_date,phone_number,email,discount) VALUES -- не 'genger', а 'gender'
...
(56, 'Leonid','Musiyenko','M','1991-06-06','380-63-855-58-20','LeonidMusiyenko@mail.com',25), -- має бути без дефісу (-)
...
('20220912081145',20,49,2, '2022-09-12 08:11:45',4), -- employee_id не є NULL
...
-- ('20230922111119',43,43,1, '2023-09-23 11:56:01',3), невірно написано  invoice_id
...
USE company;
INSERT INTO orders (orders_id, invoice_id, product_id, order_datetime, quantity) VALUES -- треба удалити employee_id і customer_id з таблиці
